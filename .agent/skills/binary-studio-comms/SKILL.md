...
- Writing social media captions, bios, or post copy for Binary Studio
- Creating web copy (landing pages, about sections, service descriptions)
- Drafting proposals, presentations, or client-facing documents
...
- Designer (co-founder)
- Systems engineer (technical partner)

### Key traits
- **Bold** — Strong visual presence, no timid design
- **Technical** — Speaks with authority on design AND code
- **Direct** — Clear communication, no corporate fluff
- **Curious** — Always exploring new tools and trends
- **Approachable** — Talks like a peer, not a corporation
...
### For Writing Copy
1. First read `references/voice-and-tone.md` to understand the brand personality and how to write as Binary Studio
2. Then reference `references/copywriting-templates.md` for ready-to-use templates for different formats (captions, bios, CTAs, headlines)
...
- `assets/logo-full.svg` — Full logo: B1NARY STUDI0
- `assets/logo-reduced.svg` — Reduced logo: 01
...
2. **Never be corporate** — Binary Studio is a small, approachable studio, not a faceless agency
3. **Anglicisms are OK** when standard in design/tech (branding, UX, wireframe, layout, etc.)
4. **Tone varies by context** — See `references/voice-and-tone.md` for the tone spectrum
5. **Content must serve one of the defined pillars** — See `references/content-strategy.md`
6. **Always respect the visual identity** — Colors, fonts, and logo usage per `references/brand-identity.md`
